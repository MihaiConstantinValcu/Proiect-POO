...
EcosistemArtificial::EcosistemArtificial(int _suprafata, int _umiditate, float _temperatura, std::string _precipitatii, std::string inputAnimale, std::string inputPlante):Ecosistem(_suprafata,_umiditate,_temperatura,_precipitatii,inputAnimale,inputPlante){}
